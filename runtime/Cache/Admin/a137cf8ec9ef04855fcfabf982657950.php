...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
    ...
    <tr> 
      <td  height="48" align="right"><strong>又拍云空间名称</strong></td>
      <td><input type="text" name="up_bucket" value="<?php echo C('up_bucket');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;详见又拍云</span>
	  </td>
    </tr>
    <tr> 
      <td  height="48" align="right"><strong>表单api密钥：</strong></td>
      <td><input type="text" name="up_form_api_secret" value="<?php echo C('up_form_api_secret');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;表单api密钥</span>
	  </td>
    </tr>
    <tr> 
      <td  height="48" align="right"><strong>又拍云相册域名：</strong></td>
      <td><input type="text" name="up_domainname" value="<?php echo C('up_domainname');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;输入分配或绑定的域名</span>
	  </td>
    </tr>
    <tr> 
      <td  height="48" align="right"><strong>又拍云操作员：</strong></td>
      <td><input type="text" name="up_username" value="<?php echo C('up_username');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;又拍云操作员</span>
	  </td>
    </tr>
    <tr> 
      <td  height="48" align="right"><strong>又拍云操作员密码：</strong></td>
      <td><input type="text" name="up_password" value="<?php echo C('up_password');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;又拍云操作员密码</span>
	  </td>
    </tr>
    <tr> 
      <td  height="48" align="right"><strong>文件上传大小限制：</strong></td>
