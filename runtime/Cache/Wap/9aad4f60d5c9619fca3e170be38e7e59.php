...
<?php if($isShow == 0): ?><div class="pwd" >
 <form action="index.php?g=Wap&m=Wedding&a=comment&id=<?php echo ($id); ?>&token=<?php echo ($Token); ?>" method="post" class="form-horizontal form-validate" novalidate="novalidate">
