...
<UL id="tags">
              <LI class="selectTag"><A href="index.php?g=User&m=Wedding&a=info&id=<?php echo ($_GET['id']); ?>">赴宴名单</A> </LI>
              <LI><A    href="index.php?g=User&m=Wedding&a=comment&id=<?php echo ($_GET['id']); ?>">收到祝福</A> </LI>
              <div class="clr"></div>
          </UL>
<DIV id=tagContent> 
...
<td class="norightborder">
	...
	<a href="javascript:drop_confirm('您确定要删除吗?', 'index.php?g=User&m=Wedding&a=info_del&id=<?php echo ($vo["id"]); ?>');">删除</a>
</td>
