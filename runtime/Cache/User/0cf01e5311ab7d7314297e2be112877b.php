...
<div class="cLineB">
  <h4><span class=""><h1>注意：必须先填写【AppId】【 AppSecret】！!</h1></span></h4>
...
<tr>
   ...
   <tbody>
  	<?php if(is_array($class)): $i = 0; $__LIST__ = $class;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$class): $mod = ($i % 2 );++$i;?><tr class="hover">
        ...
        <td>
			<a class="ajax btnGreen  cboxElement" href='' title="修改主菜单">修改</a>
			<a class=" btnGreen " href="">删除</a>
		</td>				
      </tr><?php endforeach; endif; else: echo "" ;endif; ?>
	<tr class="hover">
        <td class="td25" colspan="5">
		<?php if($class != false): ?><a class="btnGreen " onclick="drop_confirm('请确认要刷新数据吗!', '<?php echo U('Wechat_group/class_send');?>');" title="">更新分组列表</a><?php endif; ?>
