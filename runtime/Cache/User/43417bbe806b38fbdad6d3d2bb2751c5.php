...
<?php if(is_array($photo)): $i = 0; $__LIST__ = $photo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$photo): $mod = ($i % 2 );++$i;?><form method="post" action="<?php echo U('Wedding/photo_edit',array('token'=>session('token')));?>">              
<tr>
	...
	<a href="<?php echo U('wedding/photo_del',array('id'=>$photo['id'],'token'=>session('token')));?>">删除</a>
	</td>
</tr>
